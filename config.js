...
module.exports = {
SESSION_ID: process.env.SESSION_ID ||"BMB-XMD~qVBEiZxJ#F1ceouEcpJMQXPYIx2ARZbhz9uDS1WsM0u_WpHWsKPg",
// add your Session Id 
...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY 𝐷𝐸ℕ𝐵𝙊𝑌 🤍*",
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© powered by 𝐷𝐸ℕ𝐵𝙊𝑌-𝚇𝙼𝙳*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/6lwftg.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> AM ACTIVE *𝐷𝐵𝑌*⚡",
// add alive msg here 
